...
import static de.shop.util.TestConstants.ARTIKEL_BEZ_PATH_PARAM;
...
public class ArtikelResourceTest extends AbstractResourceTest {
	...
	private static final String BEZEICHNUNG_VORHANDEN = "Bluse";
	private static final String BEZEICHNUNG_NICHT_VORHANDEN = "Pampers";
	...
	public void findArtikelByBezeichnungVorhanden() {
		...
		// When
		final Response response = given().header(ACCEPT, APPLICATION_JSON)
										 .queryParameter(ARTIKEL_BEZ_PATH_PARAM, bezeichnung)
										 .get(ARTIKEL_PATH);
